...
import eu.europeana.metis.removal.dao.MongoDestinationMongoDao;
...
/**
 * Basic configuration of the remove tombstone operation.
...
public abstract class Configuration {
  ...
  private void prepareMongoSettings(IndexingSettings indexingSettings) throws IndexingException {
    ...
    indexingSettings.setMongoDatabaseName(propertiesHolder.sourceMongoTombstoneDb);
