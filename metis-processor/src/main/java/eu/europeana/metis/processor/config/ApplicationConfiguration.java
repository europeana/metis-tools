...
public class ApplicationConfiguration {
   ...
   */
  @Autowired
  public ApplicationConfiguration(TruststoreProperties propertiesHolder)
  ...
  @Bean
  public MongoProcessorDao getMongoProcessorDao(MongoProcessorProperties mongoProcessorProperties)
  ...
  @Bean
  public IndexingSettingsProvider getIndexingSettingsProvider(MongoTargetProperties mongoTargetProperties,
      SolrZookeeperTargetProperties solrZookeeperTargetProperties) {
    return new IndexingSettingsProvider(mongoTargetProperties, solrZookeeperTargetProperties);
  }

  @Bean
  public IndexerPool getIndexerPool(IndexingSettingsProvider indexingSettingsProvider)
  ...
  @Bean
  public RedissonClient getRedissonClient(RedisProperties redisProperties, TruststoreProperties truststoreProperties)
