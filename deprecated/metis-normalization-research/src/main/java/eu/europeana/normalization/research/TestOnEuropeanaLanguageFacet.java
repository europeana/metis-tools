...
public class TestOnEuropeanaLanguageFacet {
  ...
  public static void main(String[] args) throws Exception {
    ...
    try {
      ...
      List<Map<String, Object>> labels = (List<Map<String, Object>>) facets.get(0).get("fields");
      for (Map<String, Object> label : labels) {
        ...
        final boolean justCodeMatches =
            matchTypes.size() == 1 && matchTypes.contains(Type.CODE_MATCH);
