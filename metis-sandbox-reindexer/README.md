# Metis sandbox reindexer project 
Re indexes documents from a Solr query to a destination collection.
project cloned from solr-reindexer [here](https://github.com/sematext/solr-reindexer)
adapted to use maven

## Usage
Download the uber-jar from and run it with Java (11+). Here's an example with all the options:
```
java -jar metis-sandbox-reindexer.jar\
